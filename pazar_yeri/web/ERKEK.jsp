...
<html lang="en">
   <head>
       ...
       database_con data= new database_con();
         List<degiskenler> urunler =data.ana_sayfa_urunler_ust("SELECT * FROM `urunler` WHERE `urun_cinsiyet` LIKE 'erkek'ORDER BY RAND()");
      ...
      <div class="fashion_section">
         <div id="main_slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <h1 class="fashion_taital">ERKEK ÜRÜNLER</h1>
