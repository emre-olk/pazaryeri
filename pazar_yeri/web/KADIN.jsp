...
<html lang="en">
   <head>
       ...
       database_con data= new database_con();
         List<degiskenler> urunler =data.ana_sayfa_urunler_ust("SELECT * FROM `urunler` WHERE `urun_cinsiyet` LIKE 'kadın'ORDER BY RAND()");
       %>
      <!-- basic -->
      <meta charset="utf-8">
      ...
      <div class="banner_bg_main">
         ...
         <div class="logo_section">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                      <div class="logo"><a href="index.html"><h1 style="color:white"><b>Pazar yeri</b></h1></a></div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="fashion_section">
         <div id="main_slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <div class="container">
                     <h1 class="fashion_taital">KADIN ÜRÜNLER</h1>
